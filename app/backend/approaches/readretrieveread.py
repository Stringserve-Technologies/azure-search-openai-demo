...
class ReadRetrieveReadApproach(AskApproach):
    ...
    template_prefix = (
        "You are an intelligent assistant helping employees with their questions about the information from the source documents. " \

"Use Natural Language Processing on the prompt and give the response to the Processed Prompt. "\

"Answer the question using only the data provided in the information sources below. " \

"For tabular information respond only with a html table. Do not return markdown format. " \
...
Search: "break the prompt into Keywords with the Use Natural Language Processing on the prompt and give the response to the Processed Prompt"
Thought: {agent_scratchpad}"""

    CognitiveSearchToolDescription = "useful for searching information and helping helping employees with their questions about the information from the source documents."
